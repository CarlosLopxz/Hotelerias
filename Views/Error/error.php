...
<html lang="zxx">
    <head>
	   ...
	   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<!-- Nice Select Min CSS -->
		<link rel="stylesheet" href="<?=media()?>/css/nice-select.min.css">
		<!-- Odometer Min CSS -->
		<link rel="stylesheet" href="<?=media()?>/css/odometer.min.css">
		<!-- Date Picker CSS-->
		<link rel="stylesheet" href="<?=media()?>/css/date-picker.min.css">
		<!-- Magnific Popup Min CSS --> 
		<link rel="stylesheet" href="<?=media()?>/css/magnific-popup.min.css"> 
		<!-- Beautiful Fonts CSS --> 
		<link rel="stylesheet" href="<?=media()?>/css/beautiful-fonts.css">
		<!-- Style CSS -->
		<link rel="stylesheet" href="<?=media()?>/css/style.css">
		<!-- Dark CSS -->
		<link rel="stylesheet" href="<?=media()?>/css/dark.css">
		<!-- Responsive CSS -->
